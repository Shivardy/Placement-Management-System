...
<br>
  ...
  <h1 align="center"class="panel-title">Staff Login</h1></div>
...
$con=mysqli_connect($host,$user,$password,$db_name);
   ...
   if(isset($_POST['remember'])){
    setcookie ("semail",$_POST["email"],time()+ (10 * 365 * 24 * 60 * 60));  
                setcookie ("spassword",$_POST["password"],time()+ (10 * 365 * 24 * 60 * 60));  
           }
           else  
           {  
...
echo '<div class="alert alert-danger alert-dismissible" role="alert">
  ...
  <strong>Oh snap!</strong> Recheck your credentials and try submitting again.
      ...
      <form action="login" method="post">
        ...
        <input type="email" name="email" class="form-control" placeholder="Email address" required autofocus value="<?php if(isset($_COOKIE["semail"])) { echo $_COOKIE["semail"]; } ?>" >
        <label >Password</label>
        <input type="password" name="password" class="form-control" placeholder="Password" required  value="<?php if(isset($_COOKIE["spassword"])) { echo $_COOKIE["spassword"]; } ?>">
        <div class="checkbox">
          <label>
	  ...
	  <div class="panel panel-primary">
  <div class="panel-heading">
  <h1 align="center"class="panel-title">Staff Register</h1></div>
  <div class="panel-body">

  <h3 class="lead"align="center"><label>Signup and help your students in solving their doubts.</label></h3>
