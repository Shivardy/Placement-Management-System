...
<br>
           <a href="http://localhost:12/placements/admin/comjobs" class="btn btn-success">Jobs / Companies</a><br/>
...
while($row=$run->fetch_assoc()){
	...
	echo '<td><a href="'.$_SERVER['PHP_SELF'].'?did='.$row['id'].'"><button class="btn btn-danger btn-xs">Delete</button></a></td>';
